...
const string strMessageMagic = "LegitChange Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // LegitChange: 1 days
static const int64 nTargetSpacing = 420; // LegitChange: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal legitchange miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LegitChange", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xff1c47de623b3f982bb8a7eb31920a440ae3171b7e2dec03025c196cce90d324");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Seahawks hold off Saints, advance to NFC title game.  Banks Say No to Marijuana Money, Legal or Not.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389558311; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1389558311;
            block.nNonce   = 163745;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5a926a2047eb081d90eb68604fa0578d94ee4b76966670e0aaaa9ad3810d3a52"));
